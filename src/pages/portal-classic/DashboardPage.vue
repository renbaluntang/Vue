            ...
            <table class="w-full text-left border-collapse min-w-[650px]">
              ...
              <tbody class="divide-y divide-slate-100 text-sm">
                <tr
                  ...
                  :class="lesson.isNext ? 'bg-indigo-200' : ''"
                >
                  ...
                  <td class="py-3.5 px-4 text-right whitespace-nowrap">
                    <div class="inline-flex items-center justify-end gap-2 flex-nowrap">
                      <a
                        ...
                        target="_blank"
                        class="inline-flex items-center justify-center gap-1.5 px-3.5 py-2 rounded-xl bg-blue-50 text-blue-600 font-bold text-xs hover:bg-blue-100 hover:scale-105 active:scale-95 transition whitespace-nowrap flex-shrink-0 shadow-2xs"
                      >
                        <span>📹</span>
                        <span>Join Meet</span>
                      </a>
