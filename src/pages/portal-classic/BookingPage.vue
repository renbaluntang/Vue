...
<template>
  ...
  <div v-else class="min-h-screen bg-[#f1f5f9] px-3 py-6 pb-10 text-slate-800 sm:px-6">
    <div :class="`mx-auto space-y-6 transition-all duration-300 ${containerMaxWidthClass}`">
      ...
      <section class="relative overflow-hidden rounded-2xl border border-slate-900/50 p-5 text-white sm:p-6 bg-[radial-gradient(70%_90%_at_88%_6%,rgba(99,102,241,0.20),transparent_60%),linear-gradient(135deg,#0E1220_0%,#1B2140_52%,#0A0D1A_100%)]">
        ...
        <div class="relative z-10 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div class="flex items-start gap-3.5">
            <span class="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-white/10 text-xl">⚡</span>
            <div class="min-w-0">
              <div class="flex flex-wrap items-center gap-2">
                <h2 class="text-base font-extrabold tracking-tight sm:text-lg">Free Conversation</h2>
                <span class="rounded-full bg-indigo-500 px-2 py-0.5 text-[9px] font-black uppercase tracking-wider text-white">
                  Instant
                </span>
              </div>
          ...
          <button
            ...
            class="w-full shrink-0 rounded-2xl bg-indigo-600 px-6 py-3 text-sm font-bold text-white shadow-md transition-all hover:bg-indigo-700 hover:shadow-lg active:scale-95 sm:w-auto"
          >
            Start now
          </button>
        </div>
            ...
            <button
              ...
              :class="`flex h-[46px] items-center gap-2 rounded-2xl border px-3 sm:px-5 text-xs sm:text-sm font-semibold transition ${
                selectedDayKey || selectedTime
                  ? 'border-indigo-600 bg-indigo-50 text-white'
              ...
              <div class="flex flex-wrap items-center gap-2">
                ...
                <div class="relative">
                  <select
                    ...
                    class="appearance-none rounded-full border border-slate-200 bg-slate-100 py-1.5 pl-3 pr-8 text-[11px] font-semibold text-slate-700 outline-none transition hover:bg-slate-200 focus:border-indigo-600 focus:ring-2 focus:ring-indigo-100"
                  >
                  ...
                  >
                    ...
                    >
                      ...
                      <div
                        ...
                        class="absolute left-0.5 right-0.5 overflow-hidden rounded-md border-l-2 border-indigo-600 bg-indigo-50 px-1.5 py-0.5 text-[10px] font-semibold leading-tight text-white"
