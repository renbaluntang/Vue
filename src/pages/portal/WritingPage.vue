  ...
  <div class="p-4 sm:p-6 lg:p-10 max-w-7xl mx-auto space-y-5 sm:space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
      ...
      <button 
        ...
        class="w-full sm:w-auto flex items-center justify-center gap-2 px-5 py-3 sm:py-2.5 rounded-xl bg-brighture-gold text-brighture-ink font-bold shadow-md transition-all hover:bg-brighture-gold-deep hover:shadow-lg sm:hover:scale-105 active:scale-95"
      >
        ...
        <div v-if="isCreatingNew" class="flex flex-col h-full animate-in fade-in zoom-in-95">
          ...
          <div class="flex-1 overflow-y-auto p-4 sm:p-6 space-y-5">
            <div>
              ...
              <input type="text" placeholder="e.g., Self Introduction Draft" class="w-full rounded-xl border border-slate-200 bg-white py-2.5 px-4 text-sm text-slate-800 outline-none focus:border-brighture-amber focus:ring-4 focus:ring-brighture-gold/20 transition-all" />
            </div>
            <div>
              ...
              <textarea 
                ...
                class="w-full rounded-xl border border-slate-200 bg-white py-3 px-4 text-sm text-slate-800 outline-none focus:border-brighture-amber focus:ring-4 focus:ring-brighture-gold/20 transition-all resize-none"
              ></textarea>
            </div>
          </div>
          ...
          <div class="p-4 sm:p-6 border-t border-slate-100 bg-slate-50 flex justify-end gap-3">
            ...
            <button 
              ...
              class="px-5 py-2.5 rounded-xl bg-brighture-gold text-brighture-ink font-bold shadow-md hover:bg-brighture-gold-deep transition disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Submit Passage
            </button>
          </div>
            ...
            <div v-for="msg in activeThread.messages" :key="msg.id" :class="['flex gap-2.5 sm:gap-4 max-w-[92%] sm:max-w-[85%]', msg.isStudent ? 'ml-auto flex-row-reverse' : '']">
              ...
              <div :class="['space-y-1', msg.isStudent ? 'text-right' : 'text-left']">
                ...
                <div :class="[
                  ...
                  msg.isStudent 
                    ? 'bg-brighture-gold text-brighture-ink rounded-tr-sm' 
          ...
          <div class="p-3.5 sm:p-5 border-t border-slate-200 bg-white">
            ...
            <div class="relative">
              <textarea 
                ...
                class="w-full rounded-2xl border border-slate-200 bg-slate-50 py-3 pl-4 pr-14 text-sm text-slate-800 outline-none focus:border-brighture-amber focus:bg-white focus:ring-4 focus:ring-brighture-gold/20 transition-all resize-none"
              ></textarea>
              <button class="absolute bottom-3 right-3 w-8 h-8 rounded-full bg-brighture-gold text-brighture-ink flex items-center justify-center hover:bg-brighture-gold-deep hover:scale-105 transition-all shadow-md">
                ↑
              </button>
            </div>
          </div>
