      ...
      <div class="flex-1 overflow-y-auto p-5 sm:p-7 space-y-6">
        ...
        <div class="flex flex-col sm:flex-row items-center sm:items-start gap-5 pb-6 border-b border-slate-100">
          ...
          <div class="text-center sm:text-left space-y-2 flex-1">
            ...
            <p class="text-sm font-semibold text-indigo-600">{{ teacher.specialty || '[SF] Speech Fluency, [LS1] Listening & Speaking, [DC] Daily Conversation' }}</p>
            ...
            <div class="pt-1 flex flex-wrap items-center justify-center sm:justify-start gap-2">
              ...
              <button
                ...
                :class="isPlayingVoice ? 'bg-indigo-600 text-white' : 'bg-indigo-50 text-indigo-600 border border-indigo-200 hover:bg-indigo-100'"
              >
        ...
        <!-- Self Introduction -->
        <div class="relative rounded-2xl border border-indigo-100 bg-gradient-to-r from-indigo-300 to-white p-4 pl-5">
          <div class="absolute left-0 top-3 bottom-3 w-1.5 rounded-r-full bg-indigo-600"></div>
          <p class="text-[10px] font-bold uppercase tracking-wider text-indigo-600 mb-1">Instructor Self-Introduction</p>
